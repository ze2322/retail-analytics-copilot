...
with st.sidebar:
    ...
    sample_questions = [
        ...
        "What was the category with the highest total quantity during summer 2012?",
        "What was the average order value during winter 2012?",
        "What are the top 3 products by revenue of all time?",
        "What was the total revenue for beverages during summer 2012?",
        "Which customer had the best gross margin in 2012?"
    ]
